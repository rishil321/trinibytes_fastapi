...
def test_write_full_job_descriptions_to_db():
    sample_full_job_descriptions = [
        ...
        models.CaribbeanJobsPost(
            caribbeanjobs_job_id='134606',
            ...
            job_company='not disclosed',
            job_category='medical professionals & healthcare',
            job_location='port-of-spain|castries|georgetown',
            job_salary='Not disclosed',
            job_min_education_requirement='degree',
        ...
        models.CaribbeanJobsPost(
            caribbeanjobs_job_id='134746',
            url='https://www.caribbeanjobs.com/Operations-Manager-Job-134746.aspx',
            job_title='Operations Manager',
            job_company='eve anderson recruitment ltd',
            job_category='management',
            job_location='tunapuna/piarco|trincity',
            job_salary='10000 - 20000',
            job_min_education_requirement='masters degree',
